...
Route::get('/admin/program-certificates/{certificate}/preview', [ProgramCertificateController::class, 'preview'])->middleware('auth.session:admin')->name('admin.program-certificates.preview');
