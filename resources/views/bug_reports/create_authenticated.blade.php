        ...
        <section class="report-card">
            <form class="report-form" method="POST" action="{{ route('bug-reports.store') }}" enctype="multipart/form-data">
                ...
                <div class="report-fields">
                    ...
                    <div class="report-field"><label for="page_url">{{ __('bug_reports.form_page_url') }}</label><input id="page_url" name="page_url" type="url" value="{{ old('page_url', url()->previous() !== url()->current() ? url()->previous() : '') }}" placeholder="https://example.com/page"></div>
