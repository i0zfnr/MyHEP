...
<head>
    ...
    <title>{{ __('New MyHEP report') }}</title>
</head>
    ...
    <tr><td align="center" style="padding:32px 16px;">
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;max-width:620px;border:1px solid #dfd2c5;border-radius:20px;background:#fff;overflow:hidden;">
            <tr><td style="padding:24px 30px;background:linear-gradient(135deg,#3b291d,#8f6745);color:#fff;">
                <div style="font-size:20px;font-weight:800;">MyHEP</div>
            ...
            <tr><td style="padding:30px;">
                ...
                <a href="{{ route('admin.bug-reports.index') }}" style="display:inline-block;padding:13px 18px;border-radius:10px;background:#765237;color:#fff;text-decoration:none;font-weight:800;">{{ __('Review in MyHEP') }}</a>
            </td></tr>
            <tr><td style="padding:18px 30px;border-top:1px solid #eee5dc;background:#faf7f3;color:#8b7b6d;font-size:12px;line-height:1.5;">{{ __('This administrative alert contains user-submitted content. Review it inside MyHEP before taking action.') }}</td></tr>
        </table>
    </td></tr>
</table>
</body>
