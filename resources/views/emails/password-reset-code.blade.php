...
<head>
    ...
    <title>Your StudentEdge password reset code</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;max-width:620px;border:1px solid #dfd2c5;border-radius:22px;background:#ffffff;box-shadow:0 18px 45px rgba(64,45,31,.10);overflow:hidden;">
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td width="50" valign="middle">
                                        <div style="width:44px;height:44px;border-radius:13px;background:#ffffff;color:#1f5559;font-size:17px;font-weight:800;line-height:44px;text-align:center;">SE</div>
                                    </td>
                                    <td valign="middle" style="padding-left:12px;color:#ffffff;">
                                        ...
                                        <div style="padding-top:3px;color:#d7ebec;font-size:12px;letter-spacing:.5px;">SECURE ACCOUNT RECOVERY</div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding:36px 32px 32px;">
                            <div style="display:inline-block;padding:6px 10px;border:1px solid #b9ddde;border-radius:999px;background:#edf8f8;color:#1f5559;font-size:11px;font-weight:800;letter-spacing:.8px;">PASSWORD RESET</div>
                            <h1 style="margin:18px 0 10px;color:#241b15;font-size:30px;line-height:1.2;letter-spacing:-.7px;">Your verification code</h1>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin:24px 0;">
                                <tr>
                                    <td align="center" style="padding:24px 14px;border:1px solid #c9dfdf;border-radius:16px;background:#f1f8f8;">
                                        <div style="color:#1f5559;font-size:12px;font-weight:800;letter-spacing:1px;">YOUR ONE-TIME CODE</div>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td style="padding:15px 16px;border-left:4px solid #d2a168;border-radius:8px;background:#fff8ef;color:#6c4a28;font-size:13px;line-height:1.6;">
                                        <strong>Keep this code private.</strong> StudentEdge staff will never ask you to share it by phone, message, or email.
                                    </td>
                                </tr>
                            </table>

                            <p style="margin:24px 0 0;color:#6f6156;font-size:14px;line-height:1.7;">If you did not request this reset, you can safely ignore this email. Your password will remain unchanged.</p>
                        </td>
                    </tr>
                    <tr>
