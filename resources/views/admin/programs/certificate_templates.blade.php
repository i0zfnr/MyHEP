...
.cert-ai-btn{width:100%;justify-content:center;background:linear-gradient(135deg,#7c58bd,#b99150);color:#fff;border:0}.cert-ai-btn:disabled{opacity:.6;cursor:wait}.cert-ai-status{min-height:1.25rem;font-size:.84rem;font-weight:750;color:var(--text-muted,#746b62)}.cert-ai-status.success{color:#047857}.cert-ai-status.error{color:#b91c1c}.cert-clean-cover{display:none;position:absolute;z-index:2}.cert-canvas.is-detected .cert-clean-cover{display:block}.cert-drag-field{width:auto!important;min-width:76px;max-width:120px;transform:translateX(-50%);padding:.25rem .5rem!important;font-size:.7rem!important;line-height:1.1;text-align:center;white-space:nowrap;overflow:hidden}
