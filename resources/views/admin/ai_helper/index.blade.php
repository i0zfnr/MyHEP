...
<div class="miya-page">
    <div class="miya-top">
        ...
        <a href="{{ route('admin.dashboard') }}" class="miya-close" aria-label="{{ __('Close') }}">×</a>
    </div>
    ...
    <div class="miya-main">
        ...
        <div class="miya-suggests">
            <span class="miya-chip">📊 {{ __('Monthly report') }}</span>
            <span class="miya-chip">💳 {{ __('Fine applications') }}</span>
            <span class="miya-chip">🎓 {{ __('Scholarship records') }}</span>
            <span class="miya-chip">👥 {{ __('Student list') }}</span>
        </div>
