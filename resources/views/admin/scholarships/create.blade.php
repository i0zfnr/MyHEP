...
@section('header')
    <h2 style="margin:0;font-size:1.1rem;font-weight:700;color:#2d1f14;">Tambah Rekod Scholarship</h2>
@endsection
            ...
            <div class="body">
                <div class="grid grid-2">
                    ...
                    <div>
                        ...
                        <input id="provider_name" type="text" name="provider_name" value="{{ old('provider_name') }}" placeholder="Contoh: JPA / MARA">
                    </div>
                </div>
                ...
                <div style="margin-top:12px;">
                    ...
                    <input id="proof_file" type="text" name="proof_file" value="{{ old('proof_file') }}" placeholder="Contoh: uploads/proof/file.pdf">
                </div>
            </div>
        </div>

        <div class="actions">
            <button class="btn btn-primary" type="submit">Simpan Rekod</button>
