...
<div class="ui-shell">
    ...
    <div class="qr-warning">
        {{ __('This QR dynamically rotates every 15 seconds with signed cryptographic tokens. Display it on a live screen at the guard house or hostel to prevent screenshot sharing.') }}
    </div>
        ...
        <section class="ui-card">
            ...
            <div class="ui-card-body qr-print-sheet">
                @if($scanUrl)
                    ...
                    <p class="qr-help">{{ __('This QR dynamically rotates every 15 seconds with signed cryptographic HMAC tokens. Scans expire after 30 seconds to guarantee physical presence.') }}</p>
