...
@section('header')
    <h2 style="margin:0;font-size:1.1rem;font-weight:700;color:#2d1f14;">Tambah Peraturan</h2>
@endsection
...
<div class="wrap">
    ...
    <form method="POST" action="{{ route('admin.rules.store') }}">
        ...
        <div class="actions">
            <button class="btn btn-primary" type="submit">Simpan Peraturan</button>
            <a class="btn" href="{{ route('admin.rules.index') }}">Batal</a>
        </div>
    </form>
</div>
@endsection
