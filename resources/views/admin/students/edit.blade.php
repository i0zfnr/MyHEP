...
@section('header')
    <h2 style="margin:0;font-size:1.1rem;font-weight:700;color:#2d1f14;">Edit Pelajar</h2>
@endsection
...
<div class="wrap">
    ...
    <form method="POST" action="{{ route('admin.students.update', $student->id) }}">
            ...
            <div class="body">
                ...
                <div class="grid grid-2" style="margin-top:12px;">
                    <div>
                        ...
                        <input id="matric_no" type="text" name="matric_no" value="{{ old('matric_no', $student->matric_no) }}" required>
                    </div>
                    <div>
                ...
                <div class="grid grid-2" style="margin-top:12px;">
                    <div>
                        ...
                        <select id="residence_status" name="residence_status" required>
                            <option value="inside_campus" @selected(old('residence_status', $student->residence_status ?? 'inside_campus') === 'inside_campus')>Dalam Kampus</option>
                            <option value="live_out" @selected(old('residence_status', $student->residence_status ?? 'inside_campus') === 'live_out')>Live Out / Luar Kampus</option>
                        </select>
                    </div>
                    <div>
                        <label for="room_number">No. Bilik / Kolej Kediaman</label>
                        <input id="room_number" type="text" name="room_number" value="{{ old('room_number', $student->room_number) }}" placeholder="Contoh: AL306">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="actions">
            ...
            <a class="btn" href="{{ route('admin.students.index') }}">Batal</a>
        </div>
    </form>
