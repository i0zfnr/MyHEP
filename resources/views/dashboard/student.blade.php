...
@section('header')
    <h2 style="margin:0;font-size:1rem;font-weight:650;color:var(--sand-800);font-family:inherit;">
...
<div class="sdash">
    ...
    <section class="hero liquid-glass-surface liquid-glass-hero" aria-labelledby="studentWelcomeTitle">
        <div class="hero-text">
            <p class="hero-eyebrow">{{ __('MyHEP') }}</p>
            <h1 class="hero-name" id="studentWelcomeTitle"><span>{{ __('Selamat Datang,') }}</span>{{ $studentName }}</h1>
    ...
    <div class="student-portal-section">
        ...
        <div class="portal-grid">
            ...
            <a href="{{ route('student.scholarships.index') }}" class="portal-card scholarship liquid-glass-card">
            ...
            <a href="{{ route('student.offenses.index') }}" class="portal-card offense liquid-glass-card">
            ...
            <a href="{{ route('student.profile') }}" class="portal-card profile liquid-glass-card">
            ...
            <a href="{{ route('student.movements.index') }}" class="portal-card profile liquid-glass-card">
                <div class="portal-card-icon sand">
                    <svg viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm.75-11.25a.75.75 0 00-1.5 0v3.19l2.22 2.22a.75.75 0 101.06-1.06l-1.78-1.78V6.75z" clip-rule="evenodd"/></svg>
                </div>
